      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 sm:text-5xl md:text-6xl">
            Welcome to Your
            <span className="text-indigo-600"> Next.js Starter</span>
          </h1>
              ...
              <div className="flow-root bg-white rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <p className="mt-5 text-base text-gray-500">
                    Designed with context engineering in mind for optimal AI
            ...
            <div className="pt-6">
              <div className="flow-root bg-white rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <p className="mt-5 text-base text-gray-500">
                    Built with modern tools, type safety, and best practices for
            ...
            <div className="pt-6">
              <div className="flow-root bg-white rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <p className="mt-5 text-base text-gray-500">
                    Next.js 16, React 19, TypeScript, Supabase, Tailwind CSS v4,
