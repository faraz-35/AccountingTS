...
export const matchTransaction = authAction(
  matchSchema,
  async ({ bankTransactionId, journalEntryId }, { supabase }) => {
...
export const createAndMatchTransaction = authAction(
  quickCreateSchema,
  async ({ bankTransactionId, accountId, description }, { supabase }) => {
...
export const findPotentialMatches = authAction(
  z.object({ bankTransactionId: z.string().uuid() }),
  async ({ bankTransactionId }, { supabase }) => {
