  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="text-center mb-6 hidden print:block">
        <h1 className="text-2xl font-bold">Profit & Loss Statement</h1>
        <p className="text-gray-500">{start} to {end}</p>
      </div>
      ...
      <div className="bg-white shadow rounded-lg p-6 print:shadow-none">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
          ...
          <div className="p-4">
            <h3 className="text-sm font-semibold text-gray-500 uppercase mb-2">Total Expenses</h3>
            <p className="text-2xl font-bold text-red-600">
              {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(totalExpenses)}
            </p>
          </div>
          <div className="p-4 bg-gray-50 rounded-lg">
            <h3 className="text-sm font-semibold text-gray-500 uppercase mb-2">Net Income</h3>
